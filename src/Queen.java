public class Queen extends Piece {
    static final char QUEEN_LETTER = 'Q';
    static final char QUEEN_SYMBOL_WHITE = '\u2655';
    static final char QUEEN_SYMBOL_BLACK = '\u265B';

    public Queen(boolean isWhite){
        super(isWhite, QUEEN_LETTER);
        numberOfKind = 1;
        if(isWhite) symbol = QUEEN_SYMBOL_WHITE ;
        else symbol = QUEEN_SYMBOL_BLACK;
    }
